...
export default function BurialPlots() {
  ...
  const handleEditSubmit = async (payload) => {
    try {
      ...
      showError(err?.message || "Failed to update plot.");
    }
  };
